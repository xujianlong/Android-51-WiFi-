...
//                    pre_result_list[3]=0x00;  //调试
                    ...
                    command_0 = 0x01;
                    command_1 = (byte) 0xf0;
                    command_2 = command_3 = command_4 = pre_result_list[sum_num/2];
                    command = new byte[]{command_0, command_1, command_2, command_3};
                    msg.obj = command;
                    if(thread_flag&&is_send_data) {
...
//                    pre_result_list[3]=0x00;  //调试
            ...
            {
                case 10:command_1 = command_2  = "A";break;
                case 11:command_1 = command_2  = "B";break;
                default:command_1 = command_2  = String.valueOf(pre_result_list[sum_num / 2]);break;
            }
